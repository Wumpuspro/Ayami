...
module.exports = class extends Command {
    ...
    async run (message) {
        if (message.mentions.channels.first()){
            await this.client.mongodb.updateGuildSetting(message.guild.id, "cmdChannel", message.mentions.channels.first().id);
            ...
            if (message.guild.settings.cmdChannel){
                await this.client.mongodb.updateGuildSetting(message.guild.id, "cmdChannel", null);
