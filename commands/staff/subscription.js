...
module.exports = class extends Command {
    ...
    async run (message, args) {
        ...
        const guildSubscriptions = await this.client.mongodb.fetchGuildSubscriptions(guildID);
        ...
        for (const sub of guildSubscriptions){
            ...
            const payments = await this.client.mongodb.fetchSubscriptionPayments(sub.id);
            const subContents = [""];
            payments.forEach((p) => {
