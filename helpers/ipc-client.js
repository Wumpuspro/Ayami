...
module.exports.load = (discordClient) => {
    ...
    const node = new Client(`Ayami Shard #${discordClient.shard.ids[0]}`, {
        retryTime: 1000
    })
        ...
        if (message.data.event === "paypalNotification") {
            ...
            case "verification": {
                const logEmbed = new MessageEmbed()
                    .setAuthor(`${user.tag} purchased Ayami Premium`, user.displayAvatarURL())
            ...
            case "paid": {
                const logEmbed = new MessageEmbed()
                    .setAuthor(`${user.tag} paid for Ayami Premium`, user.displayAvatarURL())
